	...
	"snacks": {
		...
		"snack": [
			{"name": "Deviled Eggs with Hummus",
			 ...
			 "reviews": "I really enjoyed this recipe. The instructions were clear and I had no problem putting it together.  - John Marshall." },
...
var tableSection = Ti.UI.createTableViewSection({
	...
	for (var i=0, j=dataList[n].snack.length; i<j; i++){
		var theRow = Ti.UI.createTableViewRow({
			...
			rev: dataList[n].snack[i].reviews,
...
table.addEventListener("click", function(event) {
	...
	var revText = Ti.UI.createLabel({
		text: "Reviews: " + event.source.rev,
		textAlign: Ti.UI.TEXT_ALIGNMENT_CENTER,
		top: nutText.top + 50,
		left: 10,
		right: 10,
	...
	centerView.add(detailText, prepText, ingText, instText, nutText, revText, image);
